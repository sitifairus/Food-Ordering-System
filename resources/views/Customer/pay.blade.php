...
<?php
    $SelectedItem = session()->get('SelectedProduct');
    $total=0;
?>
      ...
      <div class="row">
        ...
        <div class="col-md-8 " >
              ...
              <div class="box-area-text payment" >
                    <table width="45%" align="right">
                        ...
                        <tr>
                            ...
                            <td style="text-align:right;"><b>{{ $order2['id'] }}</td>
                        </tr>
                        <tr>
                            <td><b>Queue Number</b></td>
                            <td style="text-align:right;"><b>{{ $order2['queue_number'] }}</b></td>
                        </tr>
                    </table>
          ...
          <div class="box-area-icon">
            <a type="button" class="btn btn-success btn-lg btn-block" href="{{route('Customer.PrintReceipt', $order2)}}">Print Receipt</a>
            <a type="button" class="btn btn-Primary btn-lg btn-block" href="{{ url('/')}}">Back To Starting Page</a> 
          </div>
        </div>
      </div>
    </div>
